...
██
 ...
 -->         
        ...
        <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js'></script>         
        <!-- CSS (Mail) ================================================== -->         
        <link rel="stylesheet" href="<?php get_theme_url(); ?>/assets/mail/css/style.css"> 
        <!-- CSS (Cdn) ================================================== -->         
        ...
        <link rel="stylesheet" href="<?php get_theme_url(); ?>/assets/countdown/css/style.css">
        <script src="<?php get_theme_url(); ?>/assets/countdown/js/index.js"></script>
        <!--
