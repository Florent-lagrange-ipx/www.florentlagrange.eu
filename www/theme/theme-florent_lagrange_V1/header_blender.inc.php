...
-->         
        ...
        <link rel="stylesheet" type="text/css" href="<?php get_theme_url(); ?>/css/style2.css"> 
                ...
                <div data-pg-name="HASHTAG" class="col-md-4 col-sm-4 col-xs-4 col-lg-4"> 
                    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12" data-pg-collapsed> 
                        <div data-pg-collapsed class="col-md-4 col-sm-4 col-xs-4 col-lg-4"> 
                            <div> 
                                <p> <img src="<?php get_theme_url(); ?>/images/gif00.gif" alt="Logo" class="logo_header" width="50%" /> </p> 
                            </div>                             
                        </div>
