...
-->         
        ...
        <link rel="stylesheet" href="http://www.florentlagrange.eu/theme/thematic/images/gif/css/style.css"> 
    ...
    <body id="<?php get_page_slug(); ?>"> 
        <div class="container" data-pg-name="HEADER"> 
            <div class="row"> 
                ...
                <!-- ------------------------------------------------------------------------------Fin Hashtag------ -->                 
                <!-- ----Début : Navigation -------------------------------------------------------------------------------- -->                 
                <div data-pg-name="HASHTAG" class="col-md-4 col-sm-4 col-xs-4 col-lg-4"> 
                    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12" data-pg-collapsed> 
                        <div data-pg-collapsed class="col-md-4 col-sm-4 col-xs-4 col-lg-4"> 
                            <div> 
                                <p> <img src="<?php get_theme_url(); ?>/images/gif00.gif" alt="Logo" class="logo_header" width="75%" /> </p> 
                            </div>                             
                        </div>
                        <div data-pg-collapsed class="col-md-8 col-sm-8 col-xs-8 col-lg-8"> 
                            <h1 class="florent_lagrange" data-pg-collapsed><?php get_site_name(); ?></h1> 
                        </div>
                        <div data-pg-collapsed class="col-md-12 col-sm-12 col-xs-12 col-lg-12"> 
                            <div id="site-name" data-pg-collapsed class="hashtag"> 
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-8 col-lg-8" data-pg-collapsed> 
                            <h1><a href="index.html"> </a></h1> 
                        </div>                         
                    </div>                     
                </div>
                <div data-pg-name="NAVIGATION" data-pg-collapsed class="col-lg-8 col-md-8 col-sm-8 col-xs-8"> 
            ...
            <div class="hr_fil_bas col-md-12" title="ARIANE" data-pg-name="ARIANE" data-pg-collapsed> 
