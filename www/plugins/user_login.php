...
register_plugin(
	...
	'Permettre aux utilisateurs de créer un compte et de se connecter à votre site Web. Protège les pages. Utilise du XML ou de la base de données.',
	'settings',
	'user_login_admin'
);
...
?>
	...
	<div style="width:100%;margin:0 -15px -15px -10px;padding:0px;">
		<h3  class="floated">Interface Plugin :Front-End User Login</h3>
		<div class="edit-nav clearfix">
			<p>
				<a href="load.php?id=user_login&help">Aide</a>
				<a href="load.php?id=user_login&settings">Installation</a>
				<a href="load.php?id=user_login&email=yes">Email Utilisateur</a>
				<a href="load.php?id=user_login&manage=yes">Gestion des utilisateur</a>
			</p>
		</div>
	</div>
	</div>
