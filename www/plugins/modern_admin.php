...
function file_mra_add_code() {
    ...
    global $file_mra_settings; 
		...
		echo '.wrapper { width: 100% } #maincontent { width: 80% } #sidebar { width: 20% } .wrapper .nav { left: 75px } .header h1 { left: 10px } .wrapper .nav li.rightnav, .wrapper #pill{ right: 60px } a.power-off, a.settings , a.help{ font-size: 2em; margin : 50px 10px } @media only screen and ( min-width : 320px ) and ( max-width : 768px ) { .wrapper { padding: 0 } .wrapper .nav { left: -3px !important; font-size: 8px !important } #maincontent, #sidebar { width: 100%; float: none } .header h1 { left: 0 } .wrapper .nav li.rightnav, .wrapper #pill{ right: 0 } } ';
