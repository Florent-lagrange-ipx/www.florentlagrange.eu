...
<h3 class="tide_title_admin"><?php echo i18n_r('tide_news/NEWS_CREATE'); ?></h3>
<form class="largeform" action="load.php?id=tide_news&amp;tide_create_news" method="post" accept-charset="utf-8">
    <div class="edit-nav" >
        <a href="#" id="metadata_toggle" accesskey="O" ><?php echo i18n_r('tide_news/NEWS_OPTIONS'); ?></a>
        <div class="clear" ></div>
    </div>

    <p id="title_holder"><input class="text title" name="title" id="title" type="text" value="<?php echo $data['title']; ?>" placeholder="<?php echo i18n_r('tide_news/NEWS_TITLE'); ?>"/></p>
    <div class="clear" ></div>
    <div style="display:none;" id="metadata_window" > 
        ...
        <div class="rightopt">
            ...
            <p class="tide_admin_label">
              ...
              <input type="checkbox" name="date_show" id="date_shows" <?php echo $data['date_show']; ?> /> 
            </p>
            <p class="tide_admin_label">
    ...
    <p id="submit_line"><input name="tide_create_news" type="submit" class="submit" value="<?php echo i18n_r('tide_news/NEWS_SAVE'); ?>" />
    </p>
</form>
